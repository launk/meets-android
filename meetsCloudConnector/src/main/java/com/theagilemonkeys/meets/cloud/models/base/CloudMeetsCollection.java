 ...
 */
public class CloudMeetsCollection<MODEL extends MeetsModel> extends ArrayList<MODEL> implements MeetsCollection<MODEL> {
     ...
     */
    public CloudMeetsCollection(){}

    public CloudMeetsCollection(Class<? extends ApiMethod> fetchApiMethodClass) {
